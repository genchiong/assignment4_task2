...
Since the first year of the study in 1999 with the highest amount of hare trappings, observations showed a notable decline throughout the years to 2012. To standardize the juvenile hare population in future analyses, I would suggest that in future analyses that the count be normalized to take into consideration the number of days and number of traps not being equal each year of the study. 
